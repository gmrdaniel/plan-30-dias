...
const TOOL_CATALOG: Record<string, ToolInfo> = {
  ...
  slack: { name: 'Slack', url: 'https://slack.com', description: 'Comunicacion interna y alertas en tiempo real entre equipos.', cost: 'Free', category: 'Comunicacion' },
  relay: { name: 'Relay.app', url: 'https://www.relay.app', description: 'Automatizacion visual de flujos. Conecta HubSpot → Slack.', cost: '$9/mes', category: 'Automatizacion' },
