...
const TOOL_CATALOG: Record<string, ToolInfo> = {
  ...
  hubspot: { name: 'HubSpot CRM', url: 'https://app.hubspot.com', description: 'CRM central. Pipelines B2B y Creadores, propiedades custom, API de contactos, workflows (Pro).', cost: '$20-90/mes (Starter→Pro)', category: 'CRM' },
  ...
  unbounce: { name: 'Unbounce', url: 'https://unbounce.com', description: 'Landing pages B2B y Creadores con DTR, hidden fields, webhooks e integracion HubSpot nativa. Paginas ilimitadas.', cost: '$99/mes (Build)', category: 'Micrositios' },
  leadpages: { name: 'Leadpages', url: 'https://www.leadpages.com', description: 'Micrositios con campos dinamicos. NOTA: Descartado para T16 — Unbounce cubre ambos micrositios.', cost: '$49/mes', category: 'Micrositios' },
  zapier: { name: 'Zapier', url: 'https://zapier.com', description: 'Automatizacion entre apps. Backup para integraciones sin webhook nativo (ManyChat → HubSpot).', cost: 'Free (100 tasks)', category: 'Automatizacion' },
  calendly: { name: 'Calendly', url: 'https://calendly.com', description: 'Agendamiento de reuniones. CTA final de micrositios B2B. Integracion nativa HubSpot.', cost: 'Free', category: 'Ventas y Cierre' },
...
const TASK_TOOLS: Record<string, string[]> = {
  ...
  'T15': ['loom', 'guidde'],
  'T16': ['unbounce', 'outgrow', 'hubspot', 'supabase', 'sendspark', 'calendly', 'zapier'],
