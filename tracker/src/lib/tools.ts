...
const TOOL_CATALOG: Record<string, ToolInfo> = {
  ...
  landingi: { name: 'Landingi', url: 'https://landingi.com', description: 'Landing pages B2B y Creadores con DTR texto + imagenes dinamicas, Smart Sections, API CRUD, A/B testing, webhooks e integracion HubSpot nativa. 50K visitas/mes, 10 dominios.', cost: '$69/mes (Professional)', category: 'Micrositios' },
...
const TASK_TOOLS: Record<string, string[]> = {
  ...
  'T15': ['loom', 'guidde'],
  'T16': ['landingi', 'outgrow', 'hubspot', 'supabase', 'sendspark', 'calendly', 'zapier'],
