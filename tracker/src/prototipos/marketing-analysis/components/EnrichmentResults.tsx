      ...
      <div className="rounded-xl border-2 border-amber-300 bg-amber-50 p-5">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          <div className="bg-white rounded-lg p-3 border border-amber-200">
            <p className="text-xs text-slate-500 uppercase">Tier A esperado</p>
            <p className="text-2xl font-bold text-emerald-600">~{projection.projectedTierA}</p>
          </div>
          <div className="bg-white rounded-lg p-3 border border-amber-200">
            <p className="text-xs text-slate-500 uppercase">Tier A+B</p>
            <p className="text-2xl font-bold text-indigo-600">~{projection.projectedTierAB.toLocaleString()}</p>
          </div>
          <div className="bg-white rounded-lg p-3 border border-amber-200">
            <p className="text-xs text-slate-500 uppercase">A+B+C</p>
            <p className="text-2xl font-bold text-amber-600">~{projection.projectedTierABC.toLocaleString()}</p>
          </div>
          <div className="bg-white rounded-lg p-3 border border-amber-200">
            <p className="text-xs text-slate-500 uppercase">Tier D descartar</p>
            <p className="text-2xl font-bold text-rose-600">~{projection.projectedDiscarded.toLocaleString()}</p>
          </div>
        </div>
      </div>
    </div>
