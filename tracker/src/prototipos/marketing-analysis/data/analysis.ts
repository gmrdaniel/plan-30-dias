...
// Enriquecimiento resultados 499 sample
export const ENRICHMENT_RESULTS = {
  ...
  fbStatus: [
    ...
    { status: 'con_fb_page (no califica)', count: 99, pct: 19.8, good: false },
  ],
  handleMatch: [
    { type: 'exact', count: 174, pct: 34.9, description: 'IG y TT normalizados son iguales' },
    { type: 'similar', count: 42, pct: 8.4, description: 'Uno contiene al otro' },
    { type: 'different', count: 96, pct: 19.2, description: 'No coinciden' },
    { type: 'no_data', count: 187, pct: 37.5, description: 'Falta uno de los dos handles' },
  ],
  topRanked: [
    { email: 'raquelamdal@gmail.com', tier: 'A', score: 13, ttFollowers: 494256, igFollowers: 131745, verified: false, fb: 'fb_profile', match: 'exact' },
    { email: 'beccaingleblog@gmail.com', tier: 'A', score: 13, ttFollowers: 491321, igFollowers: 147222, verified: true, fb: 'fb_profile', match: 'exact' },
    { email: 'rachelraysocials@gmail.com', tier: 'A', score: 13, ttFollowers: 489740, igFollowers: 122567, verified: true, fb: 'fb_profile', match: 'exact' },
    { email: 'cauaobeidusa@gmail.com', tier: 'A', score: 13, ttFollowers: 487770, igFollowers: 141567, verified: true, fb: 'fb_profile', match: 'exact' },
    { email: 'contactmesnarky@gmail.com', tier: 'A', score: 13, ttFollowers: 487080, igFollowers: 139500, verified: true, fb: 'fb_profile', match: 'exact' },
    { email: 'kvngdeonmgmt@gmail.com', tier: 'A', score: 13, ttFollowers: 477814, igFollowers: 182167, verified: false, fb: 'fb_profile', match: 'exact' },
  ],
  projection: {
    samplePct: 499 / 18907,
    fullBucketRecords: 18907,
    projectedTierA: 227,
    projectedTierAB: 7200,
    projectedTierABC: 11820,
    projectedDiscarded: 7087,
  },
}
